    ...
    <div className="space-y-4">
        ...
        <dl className="grid max-w-screen-md gap-8 mx-auto text-gray-900 sm:grid-cols-3 dark:text-white">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <dd className="font-light text-gray-500 dark:text-gray-400">Projets</dd>
          ...
          <div className="flex flex-col items-center justify-center">
            <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
              { loadingLinesOfCode ? <Loader/> :
              githubStats.linesOfCode}
            </dt>
            <dd className="font-light text-gray-500 dark:text-gray-400">Lignes de code
            
            </dd><Code className="w-6 h-6" />
          </div>

          {/* Commits */}
          <div className="flex flex-col items-center justify-center">
            <dt className="mb-2 text-3xl md:text-4xl font-extrabold">
              { loadingCommits ? <Loader/> :
              githubStats.commits}
            </dt>
            <dd className="font-light text-gray-500 dark:text-gray-400">Commits</dd>
        ...
        >
            Voir mon GitHub
            <FontAwesomeIcon icon={faGithub} className="w-4 h-4 inline-block ml-2" />
        </ a>
    </div>
  );
};
