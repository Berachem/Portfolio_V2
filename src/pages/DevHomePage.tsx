...
const experiences: Experience[] = [
    ...
    },
    {
        ...
        partners: [
            /* {"name" : "Bibliothèque Nationale de France", "url": BNFLogo},  */ {
                name: 'Musée Picasso',
                url: PicassoLogo
            },
            { name: 'Yves Saint Laurent', url: YSLogo },
            { name: 'Louis Vuitton', url: LVLogo }
        ],
            ...
            <section className="h-screen flex items-center justify-center relative overflow-hidden">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-sm sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8">
                        Bonjour, je suis Lead Software Engineer apprenti &
